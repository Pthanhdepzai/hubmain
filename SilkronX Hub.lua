loadstring(game:HttpGet("https://raw.githubusercontent.com/Pthanhdepzai/hubmain/refs/heads/main/ds"))()
...
Window = Library:CreateWindow({
    Title = "SilkronX Hub",
    Desc = "- Blox Fruit",
    Image = "rbxassetid://130480113256357"
})
...
Tabs = {
    ...
    ["Status"]   = wrapTab(Window:AddTab("Status")),
...
Tabs.Info:AddParagraph({
    ["Title"] = "Script mới bản thử nghiệm",
    ["Description"] = "Tôi sẽ Cập nhật nhiều tính năng hơn trong tương lai"
})
Tabs.Info:AddParagraph({
    ["Title"] = "Hỗ trợ tất cả các client trừ velocity",
    ["Description"] = "velocity quá béo nên đéo hỗ trợ"
})
Tabs.Info:AddParagraph({
    ["Title"] = "Supports all clients except Velocity",
    ["Description"] = "Velocity lol"
})
...
Tabs.Main:AddSlider("SliderNearestRadius", {
    ["Title"] = "Bán Kính Farm Nearest (studs)",
    ["Default"] = 150,
    ["Min"] = 50,
    ["Max"] = 500,
    ["Rounding"] = 1,
...
Tabs.Main:AddToggle("ToggleHakiFortress", {
    ["Title"] = "Activate Haki and attack Rip",
    ["Default"] = false
...
if Sea3 then
    Tabs.Sea:AddSection("insland kitsune")
    local vu487 = Tabs.Sea:AddParagraph({
        ["Title"] = "Status insland kitsune",
    })
    ...
    Tabs.Sea:AddToggle("ToggleTPKitsune", {
        ["Title"] = "Bay V\195\180 insland kitsune,
        ["Default"] = false
    ...
    Tabs.Sea:AddButton({
        ["Title"] = "\239\191\189\225\187\149i Azure",
        ["Callback"] = function()
...
if Sea3 then
    Tabs.Sea:AddSection("mysterious island")
...
-- ===============================================================
print('✅ SilkronX Hub - Tất cả tính năng đã được load!')
