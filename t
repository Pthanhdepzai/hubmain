	...
	pcall(function()
		while wait(0.2) do
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
				LcU6dwMCy1E1gRDyjUP2hdYQpurhgLo9uR:SetDesc("Mirage Island Spawning");
			else
				LcU6dwMCy1E1gRDyjUP2hdYQpurhgLo9uR:SetDesc("Mirage Island Not Spawn");
			end;
...
LcU6dwMCy1E1gRDyjUP2hdYQpurhgLo9uR = SeaStackTab:AddParagraph({
	Title = "Mirage Status",
	Desc = "N/A"
});
