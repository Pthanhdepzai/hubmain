loadstring(game:HttpGet("https://raw.githubusercontent.com/Testgameak/RYNtraxHub/refs/heads/main/attack%20fasst"))()
...
function CheckQuest()
    ...
    if World1 then
        if MyLevel >= 1 and MyLevel <= 9 then
            ...
            NameMon = "Bandit"
            CFrameQuest = CFrame.new(1059.37195, 15.4495068, 1550.40                                                                                                      231, 0.939700544, -0, -0.341998369, 0, 1, -0, 0.341998369, 0, 0.939700544)
...
Tabs = {
    ...
    Skill = Window:AddTab({ Title = "Setting Hold\n Skill Sea Event", Icon = "" }),
...
Toggle = Tabs.Server:AddToggle("Toggle", {Title = "Spam Join", Default = false })
...
Toggle = Tabs.Player:AddToggle("Toggle", { Title = "Auto Stats", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Player:AddToggle("Toggle", { Title = "Auto Summon Cake Prince", Description = "When you attack 500 monsters, you will automatically summon Cake Prince", Default = true })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Player:AddToggle("Toggle", {Title = "Black Screen", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Player:AddToggle("Toggle", {Title = "White Screen", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Player:AddToggle("Toggle", {Title = "Hide Mob", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Teleport:AddToggle("Toggle", {Title = "Teleport Island", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Auto Turn On Buso", Default = true })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Setting:AddToggle("Toggle", { Title = "Auto Turn On Race V4", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Auto Turn On Race V3", Default = false })
Toggle:OnChanged(function(Value)
...
local Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Auto Set Spawn Point", Default = false })
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Anti AFK", Default = true })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Reset Teleport", Default = false })
Toggle:OnChanged(function(Value)
    BypassTP = Value
end)
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Bring Mob", Default = true})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Spin Position", Description = "Spin Position When Farm", Default = true })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Auto Reduce Lag Farm Safely", Default = true })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Setting:AddToggle("Toggle", {Title = "Anti Cheat Farming", Description = "This feature helps you Farm safely without being detected", Default = true })
Toggle:OnChanged(function(Value)
...
Tabs.Farming:AddButton({
    ...
    Callback = function()
        pcall(function()
            setclipboard("https://discord.gg/6KQsWF6j")
        end)
    end
})
...
Dropdown = Tabs.Farming:AddDropdown("DropdownFarm", {
...
Toggle = Tabs.Farming:AddToggle("Toggle", { Title = "Start Farm", Default = false })
Toggle:OnChanged(function(Value)
...
MaterialListMon = Tabs.Farming:AddDropdown("MaterialListMon", {
...
Toggle = Tabs.Farming:AddToggle("Toggle", {Title = "Farm Material", Default = false})
Toggle:OnChanged(function(Value)
...
Slider = Tabs.Farming:AddSlider("Slider", {
     Title = "Select Health [ % ]",
     Default = 30,
     Min = 0,
     Max = 100,
...
Toggle = Tabs.Farming:AddToggle("Toggle", { Title = "Auto Farm Mastery", Default = false })
Toggle:OnChanged(function(Value)
    getgenv().MasteryFarm = Value
    StopTween(getgenv().MasteryFarm)
end)
Toggle = Tabs.Farming:AddToggle("Toggle", {Title = "Skill Z", Default = true })
Toggle:OnChanged(function(Value)
    getgenv().SkillZ = Value
end)
Toggle = Tabs.Farming:AddToggle("Toggle", {Title = "Skill X", Default = false })
Toggle:OnChanged(function(Value)
    getgenv().SkillX = Value
end)
Toggle = Tabs.Farming:AddToggle("Toggle", {Title = "Skill C", Default = false })
Toggle:OnChanged(function(Value)
    getgenv().SkillC = Value
end)
Toggle = Tabs.Farming:AddToggle("Toggle", {Title = "Skill V", Default = false })
Toggle:OnChanged(function(Value)
    getgenv().SkillV = Value
end)
Toggle = Tabs.Farming:AddToggle("Toggle", {Title = "Skill F", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", { Title = "Auto Get Melee", Default = false })
Toggle:OnChanged(function(Value)
    getgenv().AutoGetMelee = Value
    StopTween(getgenv().AutoGetMelee)
end)
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto New World", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Third World", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Factory", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", { Title = "Auto Pirate Raid", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Elite Hunter", Default = false })
Toggle:OnChanged(function(Value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    getgenv().AutoEliteHunter = Value
    StopTween(getgenv().AutoEliteHunter)
end)
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Hop Server Elite Hunter", Description = "Find New Elite Hunter Server", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Touch Pad Haki", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Rip Indra", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Soul Reaper", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Pray", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Try Luck", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Dough King", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Stack:AddToggle("Toggle", {Title = "Auto Darkbeard", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Sub:AddToggle("Toggle", {Title = "Auto Quest Dojo Trainer", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Sub:AddToggle("Toggle", {Title = "Auto Upgrade Dragon Talon", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Sub:AddToggle("Toggle", {Title = "Auto Attack Hydra Mob And Collect Ember", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Sub:AddToggle("Toggle", {Title = "Auto Collect FireFlower", Default = false })
Toggle:OnChanged(function(Value)
...
Dropdown = Tabs.Sub:AddDropdown("Dropdown", {
    Title = "Select Boss",
    Values = tableBoss,
    Multi = false,
})
...
Toggle = Tabs.Sub:AddToggle("Toggle", {Title = "Auto Kill Boss", Default = getgenv().AutoFarmBoss })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Sub:AddToggle("Toggle", {Title = "Auto Kill All Boss", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Fruit:AddToggle("Toggle", {Title = "Random Devil Fruit", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Fruit:AddToggle("Toggle", {Title = "Auto Store Fruit", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Fruit:AddToggle("Toggle", {Title = "Buy Blox Fruit Sniper Shop", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Fruit:AddToggle("Toggle", {Title = "Teleport To Fruit", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Raid:AddToggle("Toggle", {Title = "Get Fruit In Inventory Low Beli", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Raid:AddToggle("Toggle", {Title = "Auto Raid", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Raid:AddToggle("Toggle", {Title = "Auto Awaken Fruit", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Skill:AddToggle("Toggle", {
...
Toggle = Tabs.Volcanic:AddToggle("MyToggle", {Title = "Teleport Prehistoric Island", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Volcanic:AddToggle("Toggle", {
...
Toggle = Tabs.Volcanic:AddToggle("Toggle", {Title = "Auto Collect Bone", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Volcanic:AddToggle("Toggle", {Title = "Auto Collect Egg", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("Toggle", {Title = "Auto Get Cyborg", Description = "Buy Chip And Kill Order", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("Toggle", {Title = "Auto Get Ghoul", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("Toggle", { Title = "Teleport To Migare Island", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("Toggle", { Title = "Teleport To Highest Point", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("Toggle", { Title = "Teleport To Advanced Fruit Dealer", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("Toggle", { Title = "Lock Moon And On Race V3", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Race:AddToggle("Toggle", { Title = "Teleport To Blue Gear", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Trade Bone", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Buy Legendary Sword", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Get Rainbow Haki", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Skull Guitar", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Get CDK", Description = "Teleport To Claim CDK", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Yama", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Tushita", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.Item:AddToggle("Toggle", {Title = "Auto Saber", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.ESP:AddToggle("Toggle", {Title = "ESP Island", Default = false })
Toggle:OnChanged(function(Value)
    IslandESP = Value
    if IslandESP then
...
Toggle = Tabs.ESP:AddToggle("Toggle", {Title = "ESP Fruit", Default = false })
Toggle:OnChanged(function(Value)
    DevilFruitESP = Value
    if DevilFruitESP then
        if not updateConnection then
...
Toggle = Tabs.ESP:AddToggle("Toggle", {Title = "ESP Player", Default = false })
Toggle:OnChanged(function(Value)
    ESPPlayer = Value
    if ESPPlayer then
        if not updateConnection then
...
Toggle = Tabs.PVP:AddToggle("Toggle", {Title = "Auto Aimbot", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.PVP:AddToggle("Toggle", {Title = "Auto Aimbot Gun", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.PVP:AddToggle("Toggle", {Title = "Safe Modes", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.PVP:AddToggle("Toggle", { Title = "Walk On Water", Default = true })
Toggle:OnChanged(function(Value)
...
Toggle = Tabs.PVP:AddToggle("Toggle", {Title = "No Clip", Default = false })
...
Toggle = Tabs.PVP:AddToggle("Toggle", {
...
local soundId = "rbxassetid://130480113256357"
...
TextButton.Parent = ButtonScreenGui
...
TextButton.MouseButton1Click:Connect(function()
    ...
    local tween = TweenService:Create(TextButton, tweenInfo, goal)
    tween:Play()
